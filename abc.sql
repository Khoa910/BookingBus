...
INSERT INTO `bus` (`license_plate`, `seat_count`, `bus_type`, `bus_company_id`, `departure_station_id`, `arrival_station_id`) 
VALUES
...
INSERT INTO `user` (`username`, `password`, `full_name`, `phone_number`, `email`, `address`, `role`) 
VALUES
...
INSERT INTO `ticket` (`bus_id`, `user_id`, `seat_number`, `departure_time`, `price`, `status`) 
VALUES
...
-- Thêm dữ liệu vào bảng `busschedule`
INSERT INTO `busschedule` (`bus_id`, `departure_station_id`, `arrival_station_id`, `departure_time`, `arrival_time`, `price`) 
VALUES
